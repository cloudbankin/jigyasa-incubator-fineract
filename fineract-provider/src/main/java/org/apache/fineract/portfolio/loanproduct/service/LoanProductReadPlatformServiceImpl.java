...
public class LoanProductReadPlatformServiceImpl implements LoanProductReadPlatformService {
    ...
    public LoanProductReadPlatformServiceImpl(final PlatformSecurityContext context,
            ...
            final FineractEntityAccessUtil fineractEntityAccessUtil, final LoanProductRepository loanProductRepository) {
    ...
    public LoanProductData retrieveLoanProduct(final Long loanProductId) {
        ...
        try {
            ...
            final LoanProductMapper rm = new LoanProductMapper(charges, borrowerCycleVariationDatas, Installments);
    ...
    public Collection<LoanProductData> retrieveAllLoanProducts() {
        ...
        String sql = "select " + rm.loanProductSchema() +" where lp.close_date is  null";
    ...
    private static final class LoanProductMapper implements RowMapper<LoanProductData> {
		...
		private List<InstallmentsData> installments;

        public LoanProductMapper(final Collection<ChargeData> charges,
                final Collection<LoanProductBorrowerCycleVariationData> borrowerCycleVariationDatas, List<InstallmentsData> installments) {
        ...
        public LoanProductData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return new LoanProductData(id, name, shortName, description, currency, principal, minPrincipal, maxPrincipal, tolerance,
                    ...
                    graceOnPrincipalPayment, recurringMoratoriumOnPrincipalPeriods, graceOnInterestPayment, graceOnInterestCharged, this.charges, this.installments, accountingRuleType,
