...
public class LoansApiResource {
    ...
    private final Set<String> LOAN_DATA_PARAMETERS = new HashSet<>(Arrays.asList("id", "accountNo", "status", "externalId", "clientId",
            ...
            "inArrearsTolerance", "termFrequency", "termPeriodFrequencyType", "numberOfRepayments", "repaymentEvery","fixedEmiAmount",
            ...
            "meeting", "productOptions", "Installments", "amortizationTypeOptions", "interestTypeOptions", "interestCalculationPeriodTypeOptions",
            ...
            "interestRateDifferential", "isFloatingInterestRate", "interestRatesPeriods","canDefineInstallmentAmount", LoanApiConstants.canUseForTopup,
    ...
    public LoansApiResource(final PlatformSecurityContext context, final LoanReadPlatformService loanReadPlatformService,
            ...
            final EntityDatatableChecksReadService entityDatatableChecksReadService, final LoanProductRepository loanProductRepository) {
    ...
    public String template(@QueryParam("clientId") final Long clientId, @QueryParam("groupId") final Long groupId,
    	...
    	List<Installs> Install = null;
    	List<InstallmentsData> Installments = new ArrayList<>();
        ...
        if (templateType == null) {
            ...
            if (productId != null) {
	            ...
	            Install = product.getInstallments();
		            for(Installs ins : Install)
		            {
		               	long amt = ins.getIns_amt();
		            	long loan = ins.getIns_loan();	
		             InstallmentsData Array = new InstallmentsData(loan, amt);
		             Installments.add(Array); 
		            }
            }
        } else {
            ...
            if (templateType.equals("individual") || templateType.equals("jlg")) {
              ...
              if ( templateType.equals("individual")) {	
               if (productId != null) {
	                final LoanProduct product = this.loanProductRepository.findOne(productId);
	                Install = product.getInstallments();
		                for(Installs ins : Install)
...
//                InstallmentData class object 
               /* Installments = this.loanReadPlatformService.retrieveInstallments(productId);*/
                }
//                ######################
                newLoanAccount = newLoanAccount == null ? loanAccountGroupData : LoanAccountData.populateGroupDefaults(newLoanAccount,
                        loanAccountGroupData);
            ...
            newLoanAccount = LoanAccountData.associationsAndTemplate(newLoanAccount, productOptions, allowedLoanOfficers, calendarOptions,
                    accountLinkingOptions, Installments  );
        }
    ...
    public String retrieveLoan(@PathParam("loanId") final Long loanId,
        ...
        final LoanAccountData loanAccount = LoanAccountData.associationsAndTemplate(loanBasicDetails, repaymentSchedule, loanRepayments,
                ...
                overdueCharges, paidInAdvanceTemplate, interestRatesPeriods, clientActiveLoanOptions, null);
