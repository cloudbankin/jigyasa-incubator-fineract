...
public class LoanDetailData {
	...
	public LoanDetailData(long clientID, String loanAcc, String officeExtrenal, String loanType, String loanExternal,
			...
			String termfrequency, BigDecimal outBalance, String clientExternal, BigDecimal installmentAmount, BigDecimal overDueAmount, int daysOverDUe, long loanCycle, Date transactionDate,
			long writeoffAmount, String writeoffReason, Date writeoffDate) {
