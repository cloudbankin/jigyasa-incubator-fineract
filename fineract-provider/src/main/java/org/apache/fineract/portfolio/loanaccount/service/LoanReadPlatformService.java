...
//	Workbook retrieveGroupLoanSchedule(Long groupId);
// edits
//	Collection<InstallmentsData> retrieveInstallments(List<Installs> installments);

	Workbook retrieveGroupLoanSchedule(Long groupId, String fromdate, String todate);
